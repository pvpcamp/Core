...
public class UnblacklistCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        profileFuture.thenAccept(profile -> {
            ...
            Punishment punishment = profile.getActivePunishment(Punishment.Type.BLACKLIST);
            if(punishment == null) {
                sender.sendMessage(ChatColor.RED + profile.getName() + " is not currently blacklisted.");
                return;
            }
